<script lang="ts">
    ...
    const article = $derived(getArticleById(data.id));
            ...
            <div class="grid grid-cols-1 gap-16 lg:grid-cols-[1fr_320px]">
                ...
                <div>
                    ...
                    <div use:animate={{ type: 'fadeUp' }} class="mt-20 flex items-center justify-between border-t border-border/40 pt-10 gap-4">
                        {#if prevArticle}
                            <a href={`/news-and-insights/${prevArticle.id}`} class="group flex items-start gap-3 max-w-xs">
                        ...
                        {#if nextArticle}
                            <a href={`/news-and-insights/${nextArticle.id}`} class="group flex items-start gap-3 max-w-xs text-right">
                                <div>
            ...
            <div class="mx-auto max-w-7xl px-6 lg:px-8">
                ...
                <div use:animate={{ type: 'stagger', stagger: 0.12 }} class="grid gap-10 md:grid-cols-3">
                    {#each relatedArticles as related (related!.id)}
                        <a href={`/news-and-insights/${related!.id}`} class="group block">
